...
onAuthStateChanged(auth, async (user) => {
    ...
    if (user) {
        ...
        if (snap.exists() && snap.data().plan === 'lifetime') {
            ...
            // IMPORTANT: Responsive Iframe Code
...
window.saveDesign = async () => {
    ...
    alert("Design Saved! Check your Public Wall.");
};
...
// --- NEW: MY REVIEWERS TAB (Group By Month) ---
